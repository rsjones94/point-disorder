...
ax[1][1].plot(exes,whys)
ax[1][1].set_aspect(15)

ax[0][0].set_title('Neighborhoods')
ax[0][1].set_title('Point registration: Euclidean Distance')
ax[1][0].set_title('Point registration: Non-Euclidean Distance')
